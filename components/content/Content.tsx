// remover componente e deixar separado em pequenos componentes
    ...
    <div className="mx-0 sm:mx-6">
        ...
        <div className="container mx-auto flex items-center">
          <div className="flex w-1/2 pl-4 text-sm">
            <ul className="list-reset flex justify-between flex-1 md:flex-none items-center">
              <li className="mr-2">
                <Link className="inline-block py-2 px-2 text-white no-underline hover:underline"
                  href="/" >
                  Home
                </Link>
              </li>
      ...
      <div className="container font-sans bg-green-100 rounded mt-8 p-4 md:p-24 text-center">
        ...
        <h3 className="font-bold break-normal font-normal text-gray-600 text-base md:text-xl">
          Receba semanalmente as melhores dicas no seu email
        </h3>
